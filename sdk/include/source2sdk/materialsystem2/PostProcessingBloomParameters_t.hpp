...
namespace source2sdk
{
    namespace materialsystem2
    {
        ...
        static_assert(offsetof(source2sdk::materialsystem2::PostProcessingBloomParameters_t, m_flBlurWeight) == 0x20);
        static_assert(offsetof(source2sdk::materialsystem2::PostProcessingBloomParameters_t, m_vBlurTint) == 0x34);
        
        static_assert(sizeof(source2sdk::materialsystem2::PostProcessingBloomParameters_t) == 0x70);
    };
};
