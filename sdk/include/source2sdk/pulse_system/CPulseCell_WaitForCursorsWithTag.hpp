...
namespace source2sdk
{
    namespace pulse_system
    {
        ...
        public:
            ...
            source2sdk::pulse_runtime_lib::PulseCursorCancelPriority_t m_nDesiredKillPriority; // 0x84            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CPulseCell_WaitForCursorsWithTag because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::pulse_system::CPulseCell_WaitForCursorsWithTag) == 0x88);
    };
};
