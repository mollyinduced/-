...
namespace source2sdk
{
    namespace entity2
    {
        ...
        public:
            ...
            static source2sdk::entity2::GameTime_t &Get_Zero(){return *reinterpret_cast<source2sdk::entity2::GameTime_t*>(interfaces::g_schema->FindTypeScopeForModule("!GlobalTypes")->FindDeclaredClass("GameTime_t")->GetStaticFields()[1]->m_pInstance);};
        };
        #pragma pack(pop)
