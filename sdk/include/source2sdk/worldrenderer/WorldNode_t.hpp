...
namespace source2sdk
{
    namespace worldrenderer
    {
        ...
        static_assert(offsetof(source2sdk::worldrenderer::WorldNode_t, m_layerNames) == 0xc0);
        static_assert(offsetof(source2sdk::worldrenderer::WorldNode_t, m_sceneObjectLayerIndices) == 0xd8);
        static_assert(offsetof(source2sdk::worldrenderer::WorldNode_t, m_overlayLayerIndices) == 0xf0);
        ...
        static_assert(offsetof(source2sdk::worldrenderer::WorldNode_t, m_bHasBakedGeometryFlag) == 0x140);
        
        static_assert(sizeof(source2sdk::worldrenderer::WorldNode_t) == 0x148);
    };
};
