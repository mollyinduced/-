...
namespace source2sdk
{
    namespace worldrenderer
    {
        ...
        public:
            ...
            std::uint8_t m_nChartPackIterations; // 0x13            
            std::uint8_t m_nVradQuality; // 0x14            
        ...
        static_assert(offsetof(source2sdk::worldrenderer::BakedLightingInfo_t, m_nChartPackIterations) == 0x13);
        static_assert(offsetof(source2sdk::worldrenderer::BakedLightingInfo_t, m_nVradQuality) == 0x14);
