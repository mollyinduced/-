...
namespace source2sdk
{
    namespace animlib
    {
        ...
        public:
            ...
            // Static fields:
            static source2sdk::animlib::CNmSyncTrack &Get_s_defaultTrack(){return *reinterpret_cast<source2sdk::animlib::CNmSyncTrack*>(interfaces::g_schema->FindTypeScopeForModule("!GlobalTypes")->FindDeclaredClass("CNmSyncTrack")->GetStaticFields()[0]->m_pInstance);};
        };
        #pragma pack(pop)
