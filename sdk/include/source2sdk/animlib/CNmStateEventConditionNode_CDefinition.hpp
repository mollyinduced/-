...
#include "source2sdk/animlib/CNmStateEventConditionNode_Condition_t.hpp"
...
namespace source2sdk
{
    namespace animlib
    {
        ...
        #pragma pack(push, 1)
        class CNmStateEventConditionNode_CDefinition : public source2sdk::animlib::CNmBoolValueNode_CDefinition
        {
        public:
            ...
            // CUtlVectorFixedGrowable<source2sdk::animlib::CNmStateEventConditionNode_Condition_t,5> m_conditions;
        ...
        static_assert(sizeof(source2sdk::animlib::CNmStateEventConditionNode_CDefinition) == 0x80);
    };
};
