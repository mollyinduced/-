...
namespace source2sdk
{
    namespace animlib
    {
        ...
        public:
            ...
            // CUtlLeanVector<source2sdk::animlib::CNmBoneMask> m_boneMasks;
        ...
        static_assert(offsetof(source2sdk::animlib::CNmSkeleton, m_boneMasks) == 0x68);
        
        static_assert(sizeof(source2sdk::animlib::CNmSkeleton) == 0x78);
    };
};
