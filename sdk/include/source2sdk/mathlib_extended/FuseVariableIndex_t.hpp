...
namespace source2sdk
{
    namespace mathlib_extended
    {
        ...
        static_assert(offsetof(source2sdk::mathlib_extended::FuseVariableIndex_t, m_Value) == 0x0);
        
        static_assert(sizeof(source2sdk::mathlib_extended::FuseVariableIndex_t) == 0x2);
    };
};
