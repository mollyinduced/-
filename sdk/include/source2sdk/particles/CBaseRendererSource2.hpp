...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            // CUtlVector<source2sdk::particles::TextureGroup_t> m_vecTexturesInput;
            ...
            // metadata: MPropertySortPriority "500"
            source2sdk::particles::AnimationType_t m_nAnimationType; // 0xfa4            
            ...
            // metadata: MPropertySortPriority "500"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flMotionVectorScaleU; // 0xfb0            
            // metadata: MPropertyFriendlyName "motion vector scale V"
            // metadata: MPropertySortPriority "500"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flMotionVectorScaleV; // 0x1110            
            ...
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flSelfIllumAmount; // 0x1270            
            // metadata: MPropertyFriendlyName "diffuse lighting amount"
            // metadata: MPropertyAttributeRange "0 1"
            // metadata: MPropertySortPriority "400"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flDiffuseAmount; // 0x13d0            
            // metadata: MPropertyFriendlyName "diffuse max contribution clamp"
            // metadata: MPropertyAttributeRange "0 1"
            // metadata: MPropertySortPriority "400"
            // metadata: MPropertySuppressExpr "mod != hlx"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flDiffuseClamp; // 0x1530            
            // metadata: MPropertyFriendlyName "diffuse lighting origin Control Point"
            // metadata: MPropertySortPriority "400"
            std::int32_t m_nLightingControlPoint; // 0x1690            
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nSelfIllumPerParticle; // 0x1694            
            ...
            source2sdk::particles::ParticleOutputBlendMode_t m_nOutputBlendMode; // 0x1698            
            ...
            uint8_t _pad169e[0x2]; // 0x169e
            // metadata: MPropertyFriendlyName "add self amount over alphablend"
            // metadata: MPropertySortPriority "300"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flAddSelfAmount; // 0x16a0            
            // metadata: MPropertyFriendlyName "desaturation amount"
            // metadata: MPropertyAttributeRange "0 1"
            // metadata: MPropertySortPriority "300"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flDesaturation; // 0x1800            
            // metadata: MPropertyFriendlyName "overbright factor"
            // metadata: MPropertySortPriority "300"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flOverbrightFactor; // 0x1960            
            // metadata: MPropertyFriendlyName "HSV Shift Control Point"
            // metadata: MPropertySortPriority "300"
            std::int32_t m_nHSVShiftControlPoint; // 0x1ac0            
            // metadata: MPropertyFriendlyName "Apply fog to particle"
            // metadata: MPropertySortPriority "300"
            source2sdk::particles::ParticleFogType_t m_nFogType; // 0x1ac4            
            // metadata: MPropertyFriendlyName "Fog Scale"
            // metadata: MPropertySortPriority "300"
            // metadata: MPropertySuppressExpr "mod != hlx"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flFogAmount; // 0x1ac8            
            ...
            uint8_t _pad1c2a[0x2]; // 0x1c2a
            // metadata: MPropertyStartGroup "Color and alpha adjustments/Alpha Reference"
            // metadata: MPropertyFriendlyName "alpha reference"
            // metadata: MPropertySortPriority "300"
            source2sdk::particles::SpriteCardPerParticleScale_t m_nPerParticleAlphaReference; // 0x1c2c            
            // metadata: MPropertyFriendlyName "alpha reference window size"
            // metadata: MPropertySortPriority "300"
            source2sdk::particles::SpriteCardPerParticleScale_t m_nPerParticleAlphaRefWindow; // 0x1c30            
            // metadata: MPropertyFriendlyName "alpha reference type"
            // metadata: MPropertySortPriority "300"
            source2sdk::particles::ParticleAlphaReferenceType_t m_nAlphaReferenceType; // 0x1c34            
            // metadata: MPropertyFriendlyName "alpha reference softness"
            // metadata: MPropertyAttributeRange "0 1"
            // metadata: MPropertySortPriority "300"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flAlphaReferenceSoftness; // 0x1c38            
            // metadata: MPropertyFriendlyName "source alpha value to map to alpha of zero"
            // metadata: MPropertyAttributeRange "0 1"
            // metadata: MPropertySortPriority "300"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flSourceAlphaValueToMapToZero; // 0x1d98            
            // metadata: MPropertyFriendlyName "source alpha value to map to alpha of 1"
            // metadata: MPropertyAttributeRange "0 1"
            // metadata: MPropertySortPriority "300"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flSourceAlphaValueToMapToOne; // 0x1ef8            
            ...
            uint8_t _pad205a[0x6]; // 0x205a
            // metadata: MPropertyFriendlyName "refract amount"
            // metadata: MPropertyAttributeRange "-2 2"
            // metadata: MPropertySortPriority "200"
            // metadata: MPropertySuppressExpr "!m_bRefract"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flRefractAmount; // 0x2060            
            // metadata: MPropertyFriendlyName "refract blur radius"
            // metadata: MPropertySortPriority "200"
            // metadata: MPropertySuppressExpr "!m_bRefract"
            std::int32_t m_nRefractBlurRadius; // 0x21c0            
            // metadata: MPropertyFriendlyName "refract blur type"
            // metadata: MPropertySortPriority "200"
            // metadata: MPropertySuppressExpr "!m_bRefract"
            source2sdk::particles::BlurFilterType_t m_nRefractBlurType; // 0x21c4            
            ...
            uint8_t _pad22d1[0x3]; // 0x22d1
            // metadata: MPropertyFriendlyName "Depth feathering mode"
            // metadata: MPropertySortPriority "900"
            source2sdk::particles::ParticleDepthFeatheringMode_t m_nFeatheringMode; // 0x22d4            
            // metadata: MPropertyFriendlyName "particle feathering closest distance to surface"
            // metadata: MPropertySortPriority "900"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flFeatheringMinDist; // 0x22d8            
            // metadata: MPropertyFriendlyName "particle feathering farthest distance to surface"
            // metadata: MPropertySortPriority "900"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flFeatheringMaxDist; // 0x2438            
            // metadata: MPropertyFriendlyName "particle feathering filter"
            // metadata: MPropertySortPriority "900"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flFeatheringFilter; // 0x2598            
            // metadata: MPropertyFriendlyName "depth comparison bias"
            // metadata: MPropertySortPriority "900"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flDepthBias; // 0x26f8            
            // metadata: MPropertyFriendlyName "Sort Method"
            // metadata: MPropertySortPriority "900"
            source2sdk::particles::ParticleSortingChoiceList_t m_nSortMethod; // 0x2858            
            // metadata: MPropertyStartGroup "Animation"
