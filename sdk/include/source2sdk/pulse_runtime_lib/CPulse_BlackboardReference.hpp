...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        public:
            ...
            source2sdk::pulse_runtime_lib::PulseDocNodeID_t m_nNodeID; // 0xe8            
        ...
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulse_BlackboardReference, m_nNodeID) == 0xe8);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulse_BlackboardReference, m_NodeName) == 0xf0);
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulse_BlackboardReference) == 0xf8);
    };
};
