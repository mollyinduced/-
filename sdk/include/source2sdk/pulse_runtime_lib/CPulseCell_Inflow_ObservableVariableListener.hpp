...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        {
        public:
            source2sdk::pulse_runtime_lib::CPulse_BlackboardReference m_BlackboardReference; // 0x70            
        ...
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulseCell_Inflow_ObservableVariableListener) == 0x170);
    };
};
