...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        static_assert(offsetof(source2sdk::pulse_runtime_lib::PulseRuntimeEntrypointIndex_t, m_Value) == 0x0);
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::PulseRuntimeEntrypointIndex_t) == 0x4);
    };
};
