...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        public:
            ...
            source2sdk::pulse_runtime_lib::CPulse_ResumePoint m_WakeCancel; // 0x78            
            source2sdk::pulse_runtime_lib::CPulse_ResumePoint m_WakeFail; // 0xa8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CPulseCell_TestWaitWithCursorState because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulseCell_TestWaitWithCursorState) == 0xd8);
    };
};
