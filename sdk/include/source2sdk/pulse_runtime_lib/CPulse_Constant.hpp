...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulse_Constant, m_Value) == 0x10);
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulse_Constant) == 0x28);
    };
};
