...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        public:
            ...
            source2sdk::pulse_runtime_lib::CPulse_OutflowConnection m_No; // 0x78            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CPulseCell_Outflow_TestExplicitYesNo because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulseCell_Outflow_TestExplicitYesNo) == 0xa8);
    };
};
