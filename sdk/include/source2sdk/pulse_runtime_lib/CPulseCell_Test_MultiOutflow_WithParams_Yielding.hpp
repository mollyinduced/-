...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        public:
            ...
            // metadata: MPulseSignatureName
            source2sdk::pulse_runtime_lib::SignatureOutflow_Continue m_AsyncChild1; // 0x78            
            // metadata: MPulseSignatureName
            source2sdk::pulse_runtime_lib::SignatureOutflow_Continue m_AsyncChild2; // 0xa8            
            // metadata: MPulseSignatureName
            source2sdk::pulse_runtime_lib::SignatureOutflow_Resume m_YieldResume1; // 0xd8            
            // metadata: MPulseSignatureName
            source2sdk::pulse_runtime_lib::SignatureOutflow_Resume m_YieldResume2; // 0x108            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulseCell_Test_MultiOutflow_WithParams_Yielding) == 0x138);
    };
};
