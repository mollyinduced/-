...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        public:
            ...
            uint8_t _pad0128[0x50];
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_DomainIdentifier) == 0x8);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_ParentMapName) == 0x10);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_ParentXmlName) == 0x18);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_vecGameBlackboards) == 0x20);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_Chunks) == 0x38);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_Cells) == 0x50);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_Vars) == 0x68);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_PublicOutputs) == 0x80);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_InvokeBindings) == 0x98);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_CallInfos) == 0xb0);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_Constants) == 0xc8);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_DomainValues) == 0xe0);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_BlackboardReferences) == 0xf8);
        static_assert(offsetof(source2sdk::pulse_runtime_lib::CPulseGraphDef, m_OutputConnections) == 0x110);
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::CPulseGraphDef) == 0x178);
    };
};
