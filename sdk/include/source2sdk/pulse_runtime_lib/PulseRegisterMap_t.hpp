...
namespace source2sdk
{
    namespace pulse_runtime_lib
    {
        ...
        static_assert(offsetof(source2sdk::pulse_runtime_lib::PulseRegisterMap_t, m_Outparams) == 0x10);
        
        static_assert(sizeof(source2sdk::pulse_runtime_lib::PulseRegisterMap_t) == 0x20);
    };
};
