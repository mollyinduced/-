...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_PlayerDamager) == 0x28);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_PlayerRecipient) == 0x2c);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_hPlayerControllerDamager) == 0x30);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_hPlayerControllerRecipient) == 0x34);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_szPlayerDamagerName) == 0x38);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_szPlayerRecipientName) == 0x40);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_DamagerXuid) == 0x48);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_RecipientXuid) == 0x50);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_iBulletsDamage) == 0x58);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_iDamage) == 0x5c);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_iActualHealthRemoved) == 0x60);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_iNumHits) == 0x64);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_iLastBulletUpdate) == 0x68);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_bIsOtherEnemy) == 0x6c);
        static_assert(offsetof(source2sdk::server::CDamageRecord, m_killType) == 0x6d);
        
        static_assert(sizeof(source2sdk::server::CDamageRecord) == 0x70);
    };
};
