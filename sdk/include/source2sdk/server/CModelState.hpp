...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CModelState, m_bClientClothCreationSuppressed) == 0xe8);
        static_assert(offsetof(source2sdk::server::CModelState, m_MeshGroupMask) == 0x198);
        static_assert(offsetof(source2sdk::server::CModelState, m_nIdealMotionType) == 0x21a);
        static_assert(offsetof(source2sdk::server::CModelState, m_nForceLOD) == 0x21b);
        static_assert(offsetof(source2sdk::server::CModelState, m_nClothUpdateFlags) == 0x21c);
        
        static_assert(sizeof(source2sdk::server::CModelState) == 0x230);
    };
};
