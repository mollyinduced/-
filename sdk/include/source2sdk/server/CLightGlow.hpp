...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::uint32_t m_nHorizontalSize; // 0x790            
            // metadata: MNetworkEnable
            std::uint32_t m_nVerticalSize; // 0x794            
            // metadata: MNetworkEnable
            std::uint32_t m_nMinDist; // 0x798            
            // metadata: MNetworkEnable
            std::uint32_t m_nMaxDist; // 0x79c            
            // metadata: MNetworkEnable
            std::uint32_t m_nOuterMaxDist; // 0x7a0            
            // metadata: MNetworkEnable
        ...
        static_assert(sizeof(source2sdk::server::CLightGlow) == 0x7b0);
    };
};
