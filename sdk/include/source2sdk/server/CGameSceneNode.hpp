...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CGameSceneNode, m_hierarchyAttachName) == 0x138);
        static_assert(offsetof(source2sdk::server::CGameSceneNode, m_flZOffset) == 0x13c);
        static_assert(offsetof(source2sdk::server::CGameSceneNode, m_flClientLocalScale) == 0x140);
        static_assert(offsetof(source2sdk::server::CGameSceneNode, m_vRenderOrigin) == 0x144);
        
        static_assert(sizeof(source2sdk::server::CGameSceneNode) == 0x160);
    };
};
