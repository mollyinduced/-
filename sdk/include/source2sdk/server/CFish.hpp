...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CountdownTimer m_turnTimer; // 0xa00            
            bool m_turnClockwise; // 0xa18            
            uint8_t _pad0a19[0x7]; // 0xa19
            source2sdk::server::CountdownTimer m_goTimer; // 0xa20            
            source2sdk::server::CountdownTimer m_moveTimer; // 0xa38            
            source2sdk::server::CountdownTimer m_panicTimer; // 0xa50            
            source2sdk::server::CountdownTimer m_disperseTimer; // 0xa68            
            source2sdk::server::CountdownTimer m_proximityTimer; // 0xa80            
        ...
        static_assert(sizeof(source2sdk::server::CFish) == 0xab0);
    };
};
