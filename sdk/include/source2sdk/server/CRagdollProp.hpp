...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::uint32_t m_lastUpdateTickCount; // 0xa24            
            ...
            source2sdk::entity2::GameTime_t m_flLastPhysicsInfluenceTime; // 0xa38            
            source2sdk::entity2::GameTime_t m_flFadeOutStartTime; // 0xa3c            
            float m_flFadeTime; // 0xa40            
            // metadata: MNetworkDisable
            Vector m_vecLastOrigin; // 0xa44            
            source2sdk::entity2::GameTime_t m_flAwakeTime; // 0xa50            
            source2sdk::entity2::GameTime_t m_flLastOriginChangeTime; // 0xa54            
            ...
            uint8_t _pad0aa9[0x5f]; // 0xaa9
            bool m_bValidatePoweredRagdollPose; // 0xb08            
            uint8_t _pad0b09[0x3f];
        ...
        static_assert(sizeof(source2sdk::server::CRagdollProp) == 0xb48);
    };
};
