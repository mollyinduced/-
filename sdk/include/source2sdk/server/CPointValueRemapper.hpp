...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::CEntityIOOutput m_OnReachedValueZero; // 0x610            
            source2sdk::entity2::CEntityIOOutput m_OnReachedValueOne; // 0x638            
            source2sdk::entity2::CEntityIOOutput m_OnReachedValueCustom; // 0x660            
            source2sdk::entity2::CEntityIOOutput m_OnEngage; // 0x688            
            source2sdk::entity2::CEntityIOOutput m_OnDisengage; // 0x6b0            
        ...
        static_assert(sizeof(source2sdk::server::CPointValueRemapper) == 0x6d8);
    };
};
