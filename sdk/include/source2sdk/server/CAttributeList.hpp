...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CAttributeManager* m_pManager; // 0x58            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::server::CAttributeList, m_Attributes) == 0x8);
        static_assert(offsetof(source2sdk::server::CAttributeList, m_pManager) == 0x58);
        
        static_assert(sizeof(source2sdk::server::CAttributeList) == 0x60);
    };
};
