...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_iCurrentThinkContext; // 0x258            
            source2sdk::entity2::GameTick_t m_nLastThinkTick; // 0x25c            
            bool m_bDisabledContextThinks; // 0x260            
            uint8_t _pad0261[0xf]; // 0x261
            ...
            uint8_t _pad02a8[0x20]; // 0x2a8
            // metadata: MNetworkEnable
            // metadata: MNetworkSerializer "ClampHealth"
            // metadata: MNetworkUserGroup "Player"
            // metadata: MNetworkPriority "32"
            std::int32_t m_iHealth; // 0x2c8            
            // metadata: MNetworkEnable
            std::int32_t m_iMaxHealth; // 0x2cc            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "Player"
            // metadata: MNetworkPriority "32"
            std::uint8_t m_lifeState; // 0x2d0            
            uint8_t _pad02d1[0x3]; // 0x2d1
            float m_flDamageAccumulator; // 0x2d4            
            // metadata: MNetworkEnable
            bool m_bTakesDamage; // 0x2d8            
            uint8_t _pad02d9[0x7]; // 0x2d9
            // metadata: MNetworkEnable
            source2sdk::client::TakeDamageFlags_t m_nTakeDamageFlags; // 0x2e0            
            // metadata: MNetworkEnable
            source2sdk::client::EntityPlatformTypes_t m_nPlatformType; // 0x2e8            
            uint8_t _pad02e9[0x1]; // 0x2e9
            // metadata: MNetworkEnable
            source2sdk::client::MoveCollide_t m_MoveCollide; // 0x2ea            
            // metadata: MNetworkEnable
            source2sdk::client::MoveType_t m_MoveType; // 0x2eb            
            source2sdk::client::MoveType_t m_nActualMoveType; // 0x2ec            
            std::uint8_t m_nWaterTouch; // 0x2ed            
            std::uint8_t m_nSlimeTouch; // 0x2ee            
            ...
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flCreateTime; // 0x320            
            // metadata: MNetworkEnable
            bool m_bClientSideRagdoll; // 0x324            
            // metadata: MNetworkEnable
            std::uint8_t m_ubInterpolationFrame; // 0x325            
            uint8_t _pad0326[0x2]; // 0x326
            Vector m_vPrevVPhysicsUpdatePos; // 0x328            
            // metadata: MNetworkEnable
            std::uint8_t m_iTeamNum; // 0x334            
            uint8_t _pad0335[0x3]; // 0x335
            CUtlSymbolLarge m_iGlobalname; // 0x338            
            std::int32_t m_iSentToClients; // 0x340            
            // metadata: MNetworkEnable
            float m_flSpeed; // 0x344            
            CUtlString m_sUniqueHammerID; // 0x348            
            // metadata: MNetworkEnable
            std::uint32_t m_spawnflags; // 0x350            
            // metadata: MNetworkEnable
            // metadata: MNetworkUserGroup "LocalPlayerExclusive"
            source2sdk::entity2::GameTick_t m_nNextThinkTick; // 0x354            
            std::int32_t m_nSimulationTick; // 0x358            
            uint8_t _pad035c[0x4]; // 0x35c
            source2sdk::entity2::CEntityIOOutput m_OnKilled; // 0x360            
            // metadata: MNetworkEnable
            // metadata: MNetworkPriority "32"
            // metadata: MNetworkUserGroup "Player"
            ...
            // metadata: MNetworkEnable
            source2sdk::client::BloodType m_nBloodType; // 0x4d8            
            uint8_t _pad04dc[0x4];
            
            // Static fields:
            static source2sdk::server::Relationship_t** &Get_sm_DefaultRelationship(){return *reinterpret_cast<source2sdk::server::Relationship_t***>(interfaces::g_schema->FindTypeScopeForModule("server.dll")->FindDeclaredClass("CBaseEntity")->GetStaticFields()[0]->m_pInstance);};
            ...
            static std::int32_t &Get_m_nPredictionRandomSeed(){return *reinterpret_cast<std::int32_t*>(interfaces::g_schema->FindTypeScopeForModule("server.dll")->FindDeclaredClass("CBaseEntity")->GetStaticFields()[6]->m_pInstance);};
            static std::int32_t &Get_m_nPredictionRandomSeedServer(){return *reinterpret_cast<std::int32_t*>(interfaces::g_schema->FindTypeScopeForModule("server.dll")->FindDeclaredClass("CBaseEntity")->GetStaticFields()[7]->m_pInstance);};
            static source2sdk::server::CBasePlayerController* &Get_m_pPredictionPlayerController(){return *reinterpret_cast<source2sdk::server::CBasePlayerController**>(interfaces::g_schema->FindTypeScopeForModule("server.dll")->FindDeclaredClass("CBaseEntity")->GetStaticFields()[8]->m_pInstance);};
