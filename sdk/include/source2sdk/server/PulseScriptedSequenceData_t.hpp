...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ScriptedMoveTo_t m_nMoveTo; // 0x28            
            source2sdk::modellib::MovementGait_t m_nMoveToGait; // 0x2c            
            uint8_t _pad002d[0x3]; // 0x2d
            source2sdk::client::ScriptedHeldWeaponBehavior_t m_nHeldWeaponBehavior; // 0x30            
