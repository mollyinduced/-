...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad05e6[0x13a]; // 0x5e6
            source2sdk::client::ChatIgnoreType_t m_iIgnoreGlobalChat; // 0x720            
            float m_flLastPlayerTalkTime; // 0x724            
            float m_flLastEntitySteadyState; // 0x728            
            std::int32_t m_nAvailableEntitySteadyState; // 0x72c            
            bool m_bHasAnySteadyStateEnts; // 0x730            
            uint8_t _pad0731[0xf]; // 0x731
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "fixed64"
            // metadata: MNetworkChangeCallback "OnSteamIDChanged"
            std::uint64_t m_steamID; // 0x740            
            // metadata: MNetworkEnable
            std::uint32_t m_iDesiredFOV; // 0x748            
            uint8_t _pad074c[0x2c];
        ...
        static_assert(sizeof(source2sdk::server::CBasePlayerController) == 0x778);
    };
};
