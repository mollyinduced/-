...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::modellib::MovementGait_t m_nMoveToGait; // 0x524            
            ...
            std::int32_t m_nNotReadySequenceCount; // 0x55c            
            source2sdk::entity2::GameTime_t m_startTime; // 0x560            
            bool m_bWaitForBeginSequence; // 0x564            
            uint8_t _pad0565[0x3]; // 0x565
            std::int32_t m_saved_effects; // 0x568            
            std::int32_t m_savedFlags; // 0x56c            
            std::int32_t m_savedCollisionGroup; // 0x570            
            bool m_bInterruptable; // 0x574            
            bool m_sequenceStarted; // 0x575            
            bool m_bPositionRelativeToOtherEntity; // 0x576            
            uint8_t _pad0577[0x1]; // 0x577
            ...
            source2sdk::client::ScriptedOnDeath_t m_onDeathBehavior; // 0x58c            
            source2sdk::server::ScriptedConflictResponse_t m_ConflictResponse; // 0x590            
            uint8_t _pad0594[0x4]; // 0x594
            source2sdk::entity2::CEntityIOOutput m_OnBeginSequence; // 0x598            
            source2sdk::entity2::CEntityIOOutput m_OnActionStartOrLoop; // 0x5c0            
            source2sdk::entity2::CEntityIOOutput m_OnEndSequence; // 0x5e8            
            source2sdk::entity2::CEntityIOOutput m_OnPostIdleEndSequence; // 0x610            
            source2sdk::entity2::CEntityIOOutput m_OnCancelSequence; // 0x638            
            source2sdk::entity2::CEntityIOOutput m_OnCancelFailedSequence; // 0x660            
            source2sdk::entity2::CEntityIOOutput m_OnScriptEvent[8]; // 0x688            
