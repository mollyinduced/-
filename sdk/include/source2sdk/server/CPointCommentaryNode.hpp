...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad09e3[0x1]; // 0x9e3
            source2sdk::entity2::GameTime_t m_flFinishedTime; // 0x9e4            
            ...
            source2sdk::entity2::GameTime_t m_flAbortedPlaybackAt; // 0xa1c            
            source2sdk::entity2::CEntityIOOutput m_pOnCommentaryStarted; // 0xa20            
            source2sdk::entity2::CEntityIOOutput m_pOnCommentaryStopped; // 0xa48            
            // metadata: MNetworkEnable
            bool m_bActive; // 0xa70            
            uint8_t _pad0a71[0x3]; // 0xa71
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartTime; // 0xa74            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            std::int32_t m_iNodeNumber; // 0xa90            
            // metadata: MNetworkEnable
            std::int32_t m_iNodeNumberMax; // 0xa94            
            // metadata: MNetworkEnable
        ...
        static_assert(sizeof(source2sdk::server::CPointCommentaryNode) == 0xaa0);
    };
};
