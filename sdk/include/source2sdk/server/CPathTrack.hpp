...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // Static fields:
            static std::int32_t &Get_s_nCurrIterVal(){return *reinterpret_cast<std::int32_t*>(interfaces::g_schema->FindTypeScopeForModule("server.dll")->FindDeclaredClass("CPathTrack")->GetStaticFields()[0]->m_pInstance);};
