...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        static_assert(offsetof(source2sdk::animgraphlib::FollowAttachmentSettings_t, m_bMatchTranslation) == 0x84);
        static_assert(offsetof(source2sdk::animgraphlib::FollowAttachmentSettings_t, m_bMatchRotation) == 0x85);
