...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        {
        public:
            source2sdk::animgraphlib::AnimValueSource m_valueSource; // 0x68            
            source2sdk::animgraphlib::CAnimParamHandle m_paramIndex; // 0x6c            
        ...
        static_assert(sizeof(source2sdk::animgraphlib::CCycleControlUpdateNode) == 0x70);
    };
};
