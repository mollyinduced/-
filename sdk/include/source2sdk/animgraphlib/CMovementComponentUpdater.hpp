...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        public:
            ...
            source2sdk::animgraphlib::CAnimParamHandle m_paramHandles[30]; // 0x6b            
            uint8_t _pad00a7[0x1];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CMovementComponentUpdater because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::animgraphlib::CMovementComponentUpdater) == 0xa8);
    };
};
