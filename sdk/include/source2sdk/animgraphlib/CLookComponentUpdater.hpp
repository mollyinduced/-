...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        public:
            ...
            source2sdk::animgraphlib::CAnimParamHandle m_hLookHeadingVelocity; // 0x36            
            source2sdk::animgraphlib::CAnimParamHandle m_hLookPitch; // 0x38            
            source2sdk::animgraphlib::CAnimParamHandle m_hLookDistance; // 0x3a            
            source2sdk::animgraphlib::CAnimParamHandle m_hLookDirection; // 0x3c            
            source2sdk::animgraphlib::CAnimParamHandle m_hLookTarget; // 0x3e            
            source2sdk::animgraphlib::CAnimParamHandle m_hLookTargetWorldSpace; // 0x40            
