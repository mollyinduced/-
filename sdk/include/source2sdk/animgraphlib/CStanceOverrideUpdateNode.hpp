...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        public:
            ...
            source2sdk::animgraphlib::CAnimUpdateNodeRef m_pStanceSourceNode; // 0x80            
            source2sdk::animgraphlib::CAnimParamHandle m_hParameter; // 0x90            
            uint8_t _pad0092[0x2]; // 0x92
            source2sdk::animgraphlib::StanceOverrideMode m_eMode; // 0x94            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CStanceOverrideUpdateNode because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::animgraphlib::CStanceOverrideUpdateNode) == 0x98);
    };
};
