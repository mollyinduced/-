...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        {
        public:
            source2sdk::animgraphlib::FollowTargetOpFixedSettings_t m_opFixedData; // 0x68            
            uint8_t _pad0078[0x8]; // 0x78
            source2sdk::animgraphlib::CAnimParamHandle m_hParameterPosition; // 0x80            
            source2sdk::animgraphlib::CAnimParamHandle m_hParameterOrientation; // 0x82            
        ...
        static_assert(sizeof(source2sdk::animgraphlib::CFollowTargetUpdateNode) == 0x88);
    };
};
