...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ModelConfigHandle_t m_Handle; // 0x28            
        ...
        static_assert(offsetof(source2sdk::client::ActiveModelConfig_t, m_Handle) == 0x28);
        static_assert(offsetof(source2sdk::client::ActiveModelConfig_t, m_Name) == 0x30);
        static_assert(offsetof(source2sdk::client::ActiveModelConfig_t, m_AssociatedEntities) == 0x38);
        static_assert(offsetof(source2sdk::client::ActiveModelConfig_t, m_AssociatedEntityNames) == 0x50);
        
        static_assert(sizeof(source2sdk::client::ActiveModelConfig_t) == 0x68);
    };
};
