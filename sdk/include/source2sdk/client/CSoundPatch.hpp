...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // Static fields:
            static std::int32_t &Get_g_SoundPatchCount(){return *reinterpret_cast<std::int32_t*>(interfaces::g_schema->FindTypeScopeForModule("!GlobalTypes")->FindDeclaredClass("CSoundPatch")->GetStaticFields()[0]->m_pInstance);};
