...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // Static fields:
            static CUtlVector<source2sdk::client::CScriptUniformRandomStream*> &Get_sm_UniformStreams(){return *reinterpret_cast<CUtlVector<source2sdk::client::CScriptUniformRandomStream*>*>(interfaces::g_schema->FindTypeScopeForModule("!GlobalTypes")->FindDeclaredClass("CScriptUniformRandomStream")->GetStaticFields()[0]->m_pInstance);};
        };
        #pragma pack(pop)
