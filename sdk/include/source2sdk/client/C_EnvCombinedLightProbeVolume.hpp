...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nHandshake; // 0x161c            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nEnvCubeMapArrayIndex; // 0x1620            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nPriority; // 0x1624            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeSizeX; // 0x163c            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeSizeY; // 0x1640            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeSizeZ; // 0x1644            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeAtlasX; // 0x1648            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeAtlasY; // 0x164c            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeAtlasZ; // 0x1650            
            uint8_t _pad1654[0x15]; // 0x1654
            // metadata: MNetworkEnable
        ...
        static_assert(sizeof(source2sdk::client::C_EnvCombinedLightProbeVolume) == 0x1670);
    };
};
