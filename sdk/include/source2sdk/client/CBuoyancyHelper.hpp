...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CBuoyancyHelper, m_vecFractionOfWheelSubmergedForWheelFriction) == 0x20);
        static_assert(offsetof(source2sdk::client::CBuoyancyHelper, m_vecWheelFrictionScales) == 0x38);
        static_assert(offsetof(source2sdk::client::CBuoyancyHelper, m_vecFractionOfWheelSubmergedForWheelDrag) == 0x50);
        static_assert(offsetof(source2sdk::client::CBuoyancyHelper, m_vecWheelDrag) == 0x68);
        
        static_assert(sizeof(source2sdk::client::CBuoyancyHelper) == 0x80);
    };
};
