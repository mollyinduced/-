...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flTimerEndTime; // 0x570            
            // metadata: MNetworkEnable
            ...
            // metadata: MNetworkEnable
            std::int32_t m_nTimerLength; // 0x578            
            // metadata: MNetworkEnable
            std::int32_t m_nTimerInitialLength; // 0x57c            
            // metadata: MNetworkEnable
            std::int32_t m_nTimerMaxLength; // 0x580            
            // metadata: MNetworkEnable
            bool m_bAutoCountdown; // 0x584            
            uint8_t _pad0585[0x3]; // 0x585
            // metadata: MNetworkEnable
            std::int32_t m_nSetupTimeLength; // 0x588            
            // metadata: MNetworkEnable
            std::int32_t m_nState; // 0x58c            
            // metadata: MNetworkEnable
            ...
            std::int32_t m_nOldTimerLength; // 0x5a8            
            std::int32_t m_nOldTimerState; // 0x5ac            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_TeamRoundTimer because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_TeamRoundTimer) == 0x5b0);
    };
};
