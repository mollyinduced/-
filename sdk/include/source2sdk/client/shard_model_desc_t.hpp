...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_nModelID) == 0x8);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_hMaterialBase) == 0x10);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_hMaterialDamageOverlay) == 0x18);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_solid) == 0x20);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_vecPanelSize) == 0x24);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_vecStressPositionA) == 0x2c);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_vecStressPositionB) == 0x34);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_vecPanelVertices) == 0x40);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_vInitialPanelVertices) == 0x58);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_flGlassHalfThickness) == 0x70);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_bHasParent) == 0x74);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_bParentFrozen) == 0x75);
        static_assert(offsetof(source2sdk::client::shard_model_desc_t, m_SurfacePropStringToken) == 0x78);
        
        static_assert(sizeof(source2sdk::client::shard_model_desc_t) == 0x80);
    };
};
